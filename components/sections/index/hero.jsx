      ...
      <Container spacing={"VerticalXXXL"}>
        ...
        <section>
          <button
            ...
            onClick={() =>
              (window.location = "mailto:choudhari.piyush@gmail.com")
            }
          >
          ...
          <button
            ...
            onClick={() =>
              window.open(
                "https://www.linkedin.com/in/piyush-choudhari/",
                "_blank"
              )
            }
          >
          ...
          <button
            className={`button ${button.third} leaveSite`}
            onClick={() =>
              window.open("https://github.com/capybara-brain346", "_blank")
            }
          >
